...
class PromptMetadata(BaseModel):
    nctId: Optional[List[str]] = None
    status: List[Status] = Field(default_factory=list)
    startDate: List[datetime] = Field(default_factory=list)
    completionDate: List[datetime] = Field(default_factory=list)
    ...
    enrollmentCount: List[int] = Field(default_factory=list)
    healthyVolunteers: List[bool] = Field(default_factory=list)
    sex: List[Sex] = Field(default_factory=list)
    minimumAge: List[str] = Field(default_factory=list)
    maximumAge: List[str] = Field(default_factory=list)
